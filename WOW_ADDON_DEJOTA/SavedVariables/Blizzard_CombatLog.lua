	...
	["filters"] = {
		{
			...
			["tooltip"] = "Exibir mensagens de ações executadas por você.",
			["name"] = "Minhas ações",
			["colors"] = {
				["schoolColoring"] = {
					{
		...
		{
			["quickButtonName"] = "O que aconteceu comigo?",
			["onQuickBar"] = false,
			["quickButtonDisplay"] = {
				["party"] = true,
				["solo"] = true,
			...
			["tooltip"] = "Exibir tudo o que foi direcionado a mim.",
			["name"] = "O que aconteceu comigo?",
			["colors"] = {
				["schoolColoring"] = {
					{
						["a"] = 1,
