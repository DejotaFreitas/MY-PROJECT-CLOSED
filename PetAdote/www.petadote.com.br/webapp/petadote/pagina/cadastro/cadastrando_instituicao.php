...
<form id="formulario" class="formulario" action="cadastrar-instituicao" method="post" enctype="multipart/form-data">

  <?php CSRF::inserir_formulario(); ?>

  <div class="form-section form-section-foto">

    <label>Logo <span class="msg-error"><?php echo SS::s('_ss_vci_', 'foto'); ?></span></label>
  ...
  <div class="form-section">
    ...
    <?php $pais_id = SS::s('_ss_sci_', 'pais_id') ?? "1"; ?>
    <select id="pais" name="pais" value="<?php echo $pais_id; ?>" required></select><br><br>

    <label for="estado">Estado</label><br>
    <?php $estado_id = SS::s('_ss_sci_', 'estado_id') ?? "1"; ?>
    <select id="estado" name="estado" value="<?php echo $estado_id; ?>" required> </select><br><br>

    <label for="cidade">Cidade <span class="msg-error"><?php echo SS::s('_ss_vci_', 'cidade'); ?></span></label><br>
    <?php $cidade_id = SS::s('_ss_sci_', 'cidade_id') ?? "1"; ?>
  ...
  <div class="form-section">
    ...
    <label for="nome">Nome <span class="msg-error"><?php echo SS::s('_ss_vci_', 'nome'); ?></span></label><br>
    <input type="text" name="nome" id="nome" maxlength="20"   value="<?php echo SS::s('_ss_sci_', 'nome'); ?>" placeholder="PetAdote" required><br><br>

    <label for="emial">E-mail <span id="error-email" class="msg-error"><?php echo SS::s('_ss_vci_', 'email'); ?></span></label><br>
    <input type="email" name="email" id="email" maxlength="100"  value="<?php echo SS::s('_ss_sci_', 'email'); ?>" placeholder="petadote@email.com" required><br><br>

    <label for="senha">Senha <span id="error-senha" class="msg-error"><?php echo SS::s('_ss_vci_', 'senha'); ?></span></label><br>
    <input type="password" name="senha" id="senha" maxlength="20"  value="<?php echo SS::s('_ss_sci_', 'senha'); ?>" placeholder="*********" required><br><br>

  </div>

  <div class="form-section">

    <label for="cnpj">CNPJ <span id="error-cnpj" class="msg-error"><?php echo SS::s('_ss_vci_', 'cnpj'); ?></span></label><br>
    <input type="text" name="cnpj" id="cnpj" maxlength="18"  value="<?php echo SS::s('_ss_sci_', 'cnpj'); ?>"  required><br><br>

    <label for="endereco">Rua, número, bairro e etc <span class="msg-error"><?php echo SS::s('_ss_vci_', 'endereco'); ?></span></label><br>
    <input type="text" name="endereco" id="endereco" maxlength="200"   value="<?php echo SS::s('_ss_sci_', 'endereco'); ?>" placeholder="Rua jose paulo, Nº 175, bairro pitombeira" required><br><br>

    <label for="telefone">Telefone <span id="error-telefone" class="msg-error"><?php echo SS::s('_ss_vci_', 'telefone'); ?></span></label><br>
    <input type="text" name="telefone" id="telefone" maxlength="20"  value="<?php echo SS::s('_ss_sci_', 'telefone'); ?>" placeholder="(xx) xxxxx-xxxx" required><br><br>
