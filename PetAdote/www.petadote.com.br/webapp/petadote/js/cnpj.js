...
if (document.getElementById('cnpj') != null && document.getElementById('cnpj_msg_error') != null) {
  var cnpj_msg_error = document.getElementById('cnpj_msg_error');
  ...
  function reacaoValidacaoCNPJ() {
    if (validadorCNPJ()) {
      cnpj_msg_error.innerHTML = "";
    } else {
      if (cnpj.value.length > 0) {  cnpj_msg_error.innerHTML = "cnpj inválido"; }
      else { cnpj_msg_error.innerHTML = "";  }
    }
  }
