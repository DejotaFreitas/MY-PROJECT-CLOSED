...
var fotlbl_1 = document.getElementById('foto-label');
var input_file_1 = document.getElementById('input-avatar');

// =================================================================

var largura_input_1 = document.getElementById('avatar_largura');
var altura_input_1 = document.getElementById('avatar_altura');
var y_input_1 = document.getElementById('avatar_y');
var x_input_1 = document.getElementById('avatar_x');
var tamanho_input_1 = document.getElementById('selecao_tamanho');
var rotacao_input_1 = document.getElementById('rotacao');

// =================================================================

var sel_img_1 = document.getElementById('selecao_imagem');
var area_img_1 = document.getElementById('area-imagem');
var avatar_1 = document.getElementById('imagem');
var selecao_1 = document.getElementById('selecao');

// =================================================================

var ok_1 = document.getElementById('ok')
var girardireita_1 = document.getElementById('girardireita')
var giraresquerda_1 = document.getElementById('giraresquerda')
var cancela_1 = document.getElementById('cancela')
var zoommais_1 = document.getElementById('zoommais')
var zoommenos_1 = document.getElementById('zoommenos')
...
function touchMove_1(e) {
  if (e.touches.length > 1) {
    console.log("Dois ou mais dedos");
  }
  var touch = e.touches[0];
...
zoommais_1.onclick = function() {
  zoommaiss_1(); zoommaiss_1();
}

zoommenos_1.onclick = function() {
  zoommenoss_1(); zoommenoss_1();
}
...
function zoommenoss_1() {
  ...
  var rec_areaimg = area_img_1.getBoundingClientRect();
  var pos_left_1 = rec_areaimg.left + ((rec_img.right - rec_img.left) * 0.05)/2;
  var pos_top_1 = rec_areaimg.top + ((rec_img.bottom - rec_img.top) * 0.05)/2;
  area_img_1.setAttribute("style", "top: "+pos_top_1+"px; left: "+pos_left_1+"px; width:"+0+"px; height: "+0+"px;");
}
...
// sel_img_1.addEventListener('gestureend', function(e) {
//     if (e.scale < 1.0) {
//         zoommaiss_1(); zoommaiss_1();
//     } else if (e.scale > 1.0) {
//         zoommenoss_1(); zoommenoss_1();
